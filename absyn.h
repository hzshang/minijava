...
typedef struct A_method_dec_* A_method_dec;
typedef struct A_method_dec_list_* A_method_dec_list;
...
struct A_exp_ {
    enum{A_exp_ops,A_exp_sub,A_exp_length,A_exp_method,A_exp_int,A_exp_bool,A_exp_id,A_exp_this,A_exp_array,A_exp_new_id,A_exp_reverse,A_exp_exps} kind;
    union{
